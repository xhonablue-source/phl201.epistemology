    ...
    **Historical Foundations:**
    ...
    if module == "Module 1: What is Philosophy?":
        ...
        **Skepticism** questions whether knowledge is possible:
        ...
        The **Pre-Socratic philosophers** (roughly 6th and 5th centuries BCE) are known for initiating a profound shift from **mythological explanations** of the world to **rational explanations**. Instead of attributing natural phenomena to the will of the gods, they sought to understand the universe through reason and observation.

        ## Key Thinkers

        **Thales of Miletus** (~624 - 546 BCE)
        - Often considered the "Father of Western Philosophy"
        - Proposed that **water** is the fundamental substance from which all things are made.
        - His importance lies not in his conclusion, but in his **method**: he sought a natural, unified explanation for the diversity of the world.

        **Heraclitus** (~535 - 475 BCE)
        - Believed that the fundamental nature of reality is **constant change** and flux.
        - His famous statement, **"You cannot step into the same river twice,"** illustrates this core belief. The river is constantly changing, just as the person stepping into it is.
        - Saw the universe as a dynamic, ever-changing process governed by a divine "logos" or principle.

        **Parmenides** (~515 BCE)
        - The direct opposite of Heraclitus.
        - Argued that **change is an illusion** and that ultimate reality is **permanent, unified, and unchanging Being**.
        - His reasoning was based on a strict form of logic:
            - If something changes, it must become what it is not.
            - "Non-being" or "nothing" cannot be conceived or spoken of.
            - Therefore, change is impossible.

        **Zeno of Elea** (~490 - 430 BCE)
        - A student of Parmenides.
        - Created a series of **paradoxes** (like Achilles and the tortoise) designed to prove that **motion and change are logically impossible**, thereby supporting his teacher's views.

        ## The Significance of the Pre-Socratics

        They laid the groundwork for all subsequent scientific and philosophical inquiry by:
        - Introducing the idea that natural phenomena can be understood through **rational inquiry** and not just supernatural causes.
        - Establishing core debates in metaphysics (the nature of reality) that continue today.
        """)
        
    elif module == "Module 5: Knowledge vs. Opinion":
        st.subheader("Knowledge vs. Opinion")

        st.markdown("""
        ## The Distinction

        A central concern in philosophy is to distinguish **knowledge** from mere **opinion** or **belief**. While everyone can hold an opinion, knowledge requires a higher standard of justification.

        **Opinion/Belief**: A subjective conviction or a statement that is held to be true. It does not require proof or evidence.
        - Example: "I believe pineapple belongs on pizza."

        **Knowledge**: A justified true belief. For a belief to be considered knowledge, it must meet three conditions:
        1. It must be **true**.
        2. You must **believe** it.
        3. You must have a **justification** for it.

        ## The Importance of Justification

        Justification is the key element that elevates a true belief to knowledge. It is the rational support, evidence, or logical reasoning you have for holding a belief.

        - **Example**:
            - **Opinion**: "The sun will rise tomorrow." (A simple belief, no real justification provided.)
            - **Knowledge**: "The sun will rise tomorrow because the Earth rotates on its axis, and based on centuries of astronomical data, this pattern is consistent." (This belief is justified with scientific evidence.)

        ## The Problem of Truth
        
        Epistemology grapples with the question of what makes a belief "true." The most common theory is the **Correspondence Theory of Truth**.

        **Correspondence Theory**: A statement is true if it corresponds to or accurately describes a fact or state of affairs in the world.
        - Example: The statement "The cat is on the mat" is true if and only if there is a cat and a mat, and the cat is, in fact, on the mat.

        ## The Philosophical Challenge
        
        Philosophers question whether our beliefs can ever be perfectly justified or whether we can ever know for certain that our beliefs correspond to reality. This is where concepts like **Skepticism** and the **Problem of the Criterion** come into play.
        """)
        ...
        The **Upanishads** are a collection of ancient philosophical texts that form the foundational concepts of Hinduism. Written around the 8th to 6th centuries BCE, they are part of the Vedas, the sacred scriptures of ancient India. They mark a shift from the ritualistic focus of earlier Vedic texts to a more philosophical inquiry into the nature of reality and the self.

        ## Core Concepts

        **Brahman**: The ultimate, unchanging, and infinite reality that underlies all phenomena. It is the fundamental essence of the universe. It is often described as the single reality that transcends all dualities (good/evil, finite/infinite).

        **Atman**: The individual soul or self. It is the essence of a person, distinct from the physical body and personality.

        **The Great Identity**: A central and profound teaching of the Upanishads is the identity of **Atman and Brahman**. This is expressed in the famous phrase **"Tat tvam asi"**, which means **"That art thou"**. It suggests that the individual self is not separate from ultimate reality, but is, in fact, one and the same.

        ## Philosophical Implications

        The Upanishads pose a radical philosophical claim: the perceived separation between the individual and the universe is an illusion. The path to true liberation (moksha) and knowledge is to realize this identity. This contrasts sharply with many Western philosophical and religious traditions that emphasize a distinct separation between the individual and the divine or ultimate reality.

        **Knowledge vs. Ignorance**: True knowledge, according to the Upanishads, is the realization of the identity of Atman and Brahman. Ignorance (avidya) is the mistaken belief that the individual self is separate from the ultimate reality, leading to suffering and rebirth (samsara).
        """)

elif page == "🎯 Interactive Quiz":
    st.header("🎯 Interactive Philosophy Quiz")
    st.markdown("Test your knowledge of philosophy foundations and epistemology.")
    show_score()
    st.markdown("---")
    ...
    if st.session_state.current < len(st.session_state.questions):
        ...
        st.markdown(f"**You scored {st.session_state.score} XP out of a possible {len(st.session_state.questions) * 10} XP.**")
        st.write("Thanks for playing! You can review the concepts or restart the quiz.")
        restart_quiz()
    ...
    st.markdown("A quick-lookup glossary of key philosophical terms.")
    ...
    with col1:
        ...
        st.markdown("""
        **Philosophy**: "Love of wisdom." The systematic study of fundamental questions.

        **Claim**: A statement that is either true or false. The basic unit of philosophical discourse.

        **Argument**: A set of premises that support a conclusion.

        **Premise**: A statement in an argument that provides a reason or evidence.

        **Conclusion**: The statement in an argument that is supported by the premises.
        """)

        st.subheader("Epistemology")
        st.markdown("""
        **Epistemology**: The study of knowledge.

        **Knowledge**: Justified True Belief (with qualifications).

        **Justification**: The reasons or evidence for a belief.
        ...
        **Skepticism**: The view that questions the possibility of knowledge or certainty.
        """)

    with col2:
        st.subheader("Logical Errors")
        st.markdown("""
        **Vagueness**: A term with an unclear or fuzzy boundary.

        **Ambiguity**: A term with multiple possible meanings.

        **Ad Hominem**: Attacking the person making the argument instead of the argument itself.

        **Circular Reasoning**: An argument whose conclusion is one of its premises.

        **False Dichotomy**: Presenting a situation as an "either/or" choice when other options exist.
        """)

        st.subheader("Historical Figures")
        st.markdown("""
        **Thales**: First Western philosopher; sought a natural explanation for reality (water).

        **Heraclitus**: Believed reality is constant change ("all things flow").

        **Parmenides**: Believed change is an illusion; reality is unchanging Being.

        **Zeno**: Created paradoxes to support Parmenides' view that motion is impossible.
        """)

elif page == "🔗 Resources & Links":
    st.header("🔗 External Resources")
    st.markdown("""
    Expand your knowledge with these trusted external resources.

    ---

    ### **Online Courses & Videos**
    - **Coursera: Introduction to Philosophy** - A free online course from the University of Edinburgh.
    - **Khan Academy: Introduction to Philosophy** - A series of videos and articles covering core topics.
    - **Crash Course Philosophy** - A fast-paced, engaging YouTube series.
    - **The Partially Examined Life** - A podcast by a group of former philosophy graduate students.

    ---

    ### **Encyclopedias & Dictionaries**
    - **Stanford Encyclopedia of Philosophy** - The gold standard for in-depth, peer-reviewed articles on every philosophical topic.
    - **Internet Encyclopedia of Philosophy** - Another excellent, free resource with comprehensive articles.

    ---

    ### **Key Texts**
    - **Plato, *The Republic*** - A foundational text on metaphysics, epistemology, and ethics.
    - **René Descartes, *Meditations on First Philosophy*** - A classic work of rationalism and skepticism.
    - **David Hume, *An Enquiry Concerning Human Understanding*** - A foundational work of empiricism.
    """)

elif page == "🤖 AI Philosophy Tutor":
    st.header("🤖 Your AI Philosophy Tutor")
    st.markdown("Ask me anything about the topics covered in this course! I'll help clarify concepts, explain arguments, or provide more examples. The answers are generated by an AI model and may not always be accurate.")
    ...
    if st.button("Get Explanation"):
        if user_query:
            ...
            st.info("Searching for an explanation...")

            # In a real app, you would call your AI model here.
            # For this example, we'll provide a placeholder response.
            response = f"Hello! That's an excellent question. To get a high-quality answer, I would need to process your query, '{user_query}', using a robust language model. Since I'm currently a demo, I'll provide a general placeholder. You can ask me to explain topics like **'the difference between a priori and a posteriori knowledge,'** or **'what is the correspondence theory of truth?'**"
